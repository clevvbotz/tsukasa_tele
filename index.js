...
${prefix}nuliskiri Subscribe Ya YT zeeoneofc`)
        ...
        alpha.reply(util.format(e) + '\n\nFormat error akan diteruskan ke owner')
        bot.telegram.sendMessage('5784544985', 'Halo owner!, terdapat perintah yang error. Tolong difix ya!\n\n' + util.format(e))
        console.log('[ ERROR ] ' + e)
    }
}
